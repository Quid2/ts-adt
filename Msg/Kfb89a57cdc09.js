...
exports.___ = {
    ...
    decoder: function (decoders) {
        return function (st) {
            return new Msg(Kb8cd13187198.___.decoder([K066db52af145.___.decoder([])])(st), Kfced5b0f3c1f.___.decoder([])(st), K1ba230d92eb8.___.decoder([])(st));
        };
    },
};
class Msg {
    ...
    flatMaxSize() {
        return (this.fromUser.flatMaxSize() +
