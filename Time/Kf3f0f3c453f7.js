...
exports.___ = {
    ...
    decoder: function (decoders) {
        return function (st) {
            return new Time(K102a3bb904e3.___.decoder([])(st), K2412799c99f1.___.decoder([])(st));
        };
    },
};
class Time {
    ...
    pretty(nested = false) {
        return Q.nestedPars(nested, ["Time", this.utcDay.pretty(true), this.utcSecs.pretty(true)].join(" "));
    }
    match(m) {
