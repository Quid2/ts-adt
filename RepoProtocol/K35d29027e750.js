...
exports.$RepoProtocol = function (f) {
...
exports.___ = {
    ...
    decoder: function (decoders) {
        return function (st) {
            if (st.zero()) {
                if (st.zero()) {
                    return new Record(K3e8257255cbf.___.decoder([
                    ...
                    if (st.zero()) {
                        ...
                        return new Solved(K4bbd38587b9e.___.decoder([])(st), K3e8257255cbf.___.decoder([
                            Kdc26e9d90047.___.decoder([]),
                            Kdc26e9d90047.___.decoder([]),
                            K07b1b045ac3c.___.decoder([K4bbd38587b9e.___.decoder([])]),
                        ])(st));
                ...
                if (st.zero()) {
                    if (st.zero()) {
                        ...
                        return new KnownDataTypes(Kb8cd13187198.___.decoder([
                    ...
                    if (st.zero()) {
                        ...
                        return new KnownDataTypesRefs(Kb8cd13187198.___.decoder([
                            Ka5583bf3ad34.___.decoder([
                                K4bbd38587b9e.___.decoder([]),
...
class Solved {
    ...
    pretty(nested = false) {
        return Q.nestedPars(nested, ["Solved", this._0.pretty(true), this._1.pretty(true)].join(" "));
    }
    match(m) {
...
class KnownDataTypes {
    ...
    pretty(nested = false) {
        return Q.nestedPars(nested, ["KnownDataTypes", this._0.pretty(true)].join(" "));
    }
    match(m) {
...
class KnownDataTypesRefs {
    ...
    toStr(nested = false) {
        return Q.nestedPars(nested, ["KnownDataTypesRefs", this._0.toStr(true)].join(" "));
    }
    pretty(nested = false) {
        return Q.nestedPars(nested, ["KnownDataTypesRefs", this._0.pretty(true)].join(" "));
    }
    match(m) {
